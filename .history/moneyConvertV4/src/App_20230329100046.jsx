    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          <select id="from-currency-select" onChange={setEntryCurrency(currency)}>{currencies.map((currency) => { return (<option >{entryCurrency}</option>) })}</select>
          <select id="to-currency-select">{currencies.map((currency) => { return (<option>{exitCurrency}</option>) })}</select>
        </div>
