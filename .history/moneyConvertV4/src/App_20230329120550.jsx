...
function App() {
  ...
  console.log(JSON.stringify(import.meta.env.VITE_REACT_API_URL))
  //JSON.stringify(import.meta.env).split('":"')[1].split('","')[0]

  let api = `https://v6.exchangerate-api.com/v6/${JSON.stringify(import.meta.env.VITE_REACT_API_URL)}/latest/USD`;
    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          ...
          <select id="to-currency-select" value={exitCurrency} onChange={e => setExitCurrency(e.target.value)} >
            {currencies.map((currency) => { return (<option>{currency}</option>) })}
          </select>
        </div>
