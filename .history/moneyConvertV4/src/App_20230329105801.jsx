...
function App() {
  ...
  let [intValue, setIntValue] = useEffect
  ...
  return (
    <div>
      <div className="wrapper">
        ...
        <input type="number" id="amount" value="100" onChange={e => this.setState({ text: e.target.value })} />

        <div className="dropdowns">
          <select id="from-currency-select" >{currencies.map((currency) => { return (<option >{currency}</option>) })}</select>
