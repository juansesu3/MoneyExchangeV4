    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          <select id="from-currency-select">{currencies.map((currency) => { return (<option>{setEntryCurrency(currency)}</option>) })}</select>
          <select id="to-currency-select">{currencies.map((currency) => { return (<option>{setEntryCurrency(currency)}</option>) })}</select>
        </div>
