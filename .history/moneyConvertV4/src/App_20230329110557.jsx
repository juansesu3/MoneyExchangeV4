    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          <select id="from-currency-select" >{currencies.map((currency) => { return (<option value={entryCurrency} onChange={e => setEntryCurrency({txte.target.value}) } >{currency}</option>) })}</select>
