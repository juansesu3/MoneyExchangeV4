...
function App() {
  ...
  let [entryCurrency, setEntryCurrency]= useState(currencies)
    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          <select id="from-currency-select" >{currencies.map((currency) => { return (<option onChange={e => setEntryCurrency(currency )}>{entryCurrency}</option>) })}</select>
