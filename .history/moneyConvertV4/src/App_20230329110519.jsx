    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          <select id="from-currency-select" >{currencies.map((currency) => { return (<option text={entryCurrency} onChange={e=> setEntryCurrency(e.target.value) } >{currency}</option>) })}</select>
