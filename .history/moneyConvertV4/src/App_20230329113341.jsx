    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          ...
          <select id="to-currency-select" value={entryCurrency} onChange={e => setEntryCurrency(e.target.value )} >{currencies.map((currency) => { return (<option>{currency}</option>) })}</select>
        </div>
