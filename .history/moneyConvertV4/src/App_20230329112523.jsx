...
function App() {
  ...
  let [entryCurrency, setEntryCurrency]= useState([])
    ...
    <div>
      <div className="wrapper">
        ...
        <div className="dropdowns">
          <select id="from-currency-select" >{currencies.map((currency) => { return (<option onChange={e => setEntryCurrency(e.target.value )}>{entryCurrency}</option>) })}</select>
